...
invertNavbarColor = () => {
  ...
  const harmburger = document.querySelector(".dnavbar-harmburger").children;
  const sidebarFirstTitle = document.querySelector(".dnavbar-list-item--first");
  window.onscroll = () => {
    let scrollTop =
    ...
    if (scrollTop > 72) {
      ...
      sidebarFirstTitle.style.borderTop = "none";
      ...
      sidebarFirstTitle.style.borderTop = "1px solid #cadef9";
    }
  };
};
carousel = () => {
...
sidebarTrigger = () => {
  const harmburger = document.querySelector(".dnavbar-harmburger");
  const closeButton = document.querySelector(".dnavbar-closeButton");
  const mobileWrapper = document.querySelector(".dnavbar-mobileWrapper");
  const overlay = document.querySelector(".overlay");
  open = false;
  harmburger.addEventListener("click", () => {
    overlay.style.display = "block";
    mobileWrapper.style.right = "0px";
  });
  closeButton.addEventListener("click", () => {
    mobileWrapper.style.right = "-387px";
